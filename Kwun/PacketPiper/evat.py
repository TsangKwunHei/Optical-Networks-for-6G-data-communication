...
def main():
    ...
    if USE_INPUT_TXT:
        ...
        try:
            ...
            print("Error reading input_sim.txt:", e)
            sys.exit(1)
    else:
    ...
    if EVALUATE_CONSTRAINTS:
        ...
        if not constraint1_met:
            ...
            for check in constraint1_checks:
                if not check['meets_constraint']:
                    ...
                    print(f"Between te={check['prev_te']} and te={check['te_km']}: Actual gap {actual_gap} ns, Required gap {required_gap} ns ({percentage:.2f}% of required)")
        else:
        ...
        if constraint1_checks:
            ...
            if percentages:
                ...
                print("\nNo valid data for Constraint 1 percentages.")
        ...
        if constraint2_checks:
            ...
            if percentages:
                ...
                print("\nNo valid data for Constraint 2 percentages.")
        ...
        if te_gaps:
            ...
            print("\nNo valid data for Constraint 3 gaps.")
